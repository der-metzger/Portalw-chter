...
By Rochet2 http://rochet2.github.io/

Übersetzung von der_metzger https://github.com/der-metzger
*/
...
(15, @GOSSIP_MENU+5, 3, 6, 67, "Tirisfal"),
...
(15, @GOSSIP_MENU+1, 2, 6, 469, "Verlies"),
(15, @GOSSIP_MENU+1, 3, 6, 67, "Flammenschlund"),
(15, @GOSSIP_MENU+1, 4, 6, 67, "Hügel von Razorfen"),
(15, @GOSSIP_MENU+1, 5, 6, 67, "Kral der Klingenhauer"),
(15, @GOSSIP_MENU+1, 6, 6, 67, "Scharlachrote Kloster"),
(15, @GOSSIP_MENU+1, 7, 6, 67, "Burg Schattenfang"),
(15, @GOSSIP_MENU+1, 8, 6, 67, "Höhlen des Wehklagens"),
(15, @GOSSIP_MENU+6, 9, 6, 67, "Tausend Nadeln"),
(14, @GOSSIP_MENU, @TEXT_ID+1, 6, 469, "Für die Alianz"),
...
-- Gossip options:
-- Bist du sicher, dass du nach Sturmwind willst?
...
(@GOSSIP_MENU, 1, 2, "Sturmwind", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Sturmwind willst?"),
(@GOSSIP_MENU, 2, 2, "Orgrimmar", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Orgrimmar willst?"),
(@GOSSIP_MENU, 3, 2, "Darnassus", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Darnassus willst?"),
(@GOSSIP_MENU, 4, 2, "Eisenschmiede", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Eisenschmiede willst?"),
(@GOSSIP_MENU, 5, 2, "Exodar", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Exodar willst?"),
(@GOSSIP_MENU, 6, 2, "Donnerfels", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Donnerfels willst?"),
(@GOSSIP_MENU, 7, 2, "Unterstadt", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Unterstadt willst?"),
(@GOSSIP_MENU, 8, 2, "Silbermond", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Silbermond willst?"),
(@GOSSIP_MENU, 9, 2, "Dalaran", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Dalaran willst?"),
(@GOSSIP_MENU, 10, 2, "Shattrath", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Shattrath willst?"),
(@GOSSIP_MENU, 11, 2, "Beutebucht", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du zur Beutebucht willst?"),
(@GOSSIP_MENU, 12, 2, "Arena der Gurubashi", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du in die Arena der Gurubashi willst?"),
(@GOSSIP_MENU, 13, 3, "Östliche Königreich", 1, 1, @GOSSIP_MENU+5, 0, 0, 0, NULL),
...
(@GOSSIP_MENU, 17, 9, "Klassische Dungeons", 1, 1, @GOSSIP_MENU+1, 0, 0, 0, NULL),
...
(@GOSSIP_MENU+1, 0, 2, "Gnomeregan", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Gnomeregan willst?"),
(@GOSSIP_MENU+1, 1, 2, "Todesminen", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in die Todesminen willst?"),
(@GOSSIP_MENU+1, 2, 2, "Verlies", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in das Verlies  willst?"),
(@GOSSIP_MENU+1, 3, 2, "Flammenschlund", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in den Flammenschlund willst?"),
(@GOSSIP_MENU+1, 4, 2, "Hügel von Razorfen", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zum Hügel von Razorfen willst?"),
(@GOSSIP_MENU+1, 5, 2, "Kral der Klingenhauer", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zum Kral der Klingenhauer willst?"),
(@GOSSIP_MENU+1, 6, 2, "Scharlachrote Kloster", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in das Scharlachrote Kloster willst?"),
(@GOSSIP_MENU+1, 7, 2, "Burg Schattenfang", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in die Burg Schattenfang willst?"),
(@GOSSIP_MENU+1, 8, 2, "Höhlen des Wehklagens", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in die Höhlen des Wehklagens willst?"),
(@GOSSIP_MENU+1, 9, 2, "Tiefschwarze Grotte", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in die Tiefschwarze Grotte willst?"),
(@GOSSIP_MENU+1, 10, 2, "Schwarzfelstiefen", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Schwarzfelstiefen willst?"),
(@GOSSIP_MENU+1, 11, 2, "Schwarzfelsspitze", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zur Schwarzfelsspitze willst?"),
(@GOSSIP_MENU+1, 12, 2, "Düsterbruch", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Düsterbruch willst?"),
(@GOSSIP_MENU+1, 13, 2, "Maraudon", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Maraudon willst?"),
(@GOSSIP_MENU+1, 14, 2, "Scholomance", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Scholomance willst?"),
(@GOSSIP_MENU+1, 15, 2, "Stratholme", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Stratholme willst?"),
(@GOSSIP_MENU+1, 16, 2, "Tempel von Atal'Hakkar", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zu dem Tempel von Atal'Hakkar willst?"),
(@GOSSIP_MENU+1, 17, 2, "Uldaman", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Uldaman willst?"),
(@GOSSIP_MENU+1, 18, 2, "Zul'Farrak", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Zul'Farrak willst?"),
(@GOSSIP_MENU+1, 19, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+2, 0, 2, "Auchindoun", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Auchindoun willst?"),
(@GOSSIP_MENU+2, 1, 2, "Höhlen der Zeit", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in die Höhlen der Zeit willst?"),
(@GOSSIP_MENU+2, 2, 2, "Coilfang Reservoir", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Coilfang Reservoir willst?"),
(@GOSSIP_MENU+2, 3, 2, "Hellfire Citadel", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Hellfire Citadel willst?"),
(@GOSSIP_MENU+2, 4, 2, "Magisters' Terrace", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zu Magisters' Terrace willst?"),
(@GOSSIP_MENU+2, 5, 2, "Tempest Keep", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Tempest Keep willst?"),
(@GOSSIP_MENU+2, 6, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+3, 0, 2, "Azjol-Nerub", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Azjol-Nerub willst?"),
(@GOSSIP_MENU+3, 1, 2, "Ausmerzen von Stratholme", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Ausmerzen von Stratholme willst?"),
(@GOSSIP_MENU+3, 2, 2, "Prüfung des Champions", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Prüfung des Champions willst?"),
(@GOSSIP_MENU+3, 3, 2, "Feste Drak'Tharon", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zur Feste Drak'Tharon willst?"),
(@GOSSIP_MENU+3, 4, 2, "Gundrak", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Gundrak willst?"),
(@GOSSIP_MENU+3, 5, 2, "Eiskronenzitadelle", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zur Eiskronenzitadelle willst?"),
(@GOSSIP_MENU+3, 6, 2, "The Nexus Dungeons", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach The Nexus Dungeons willst?"),
(@GOSSIP_MENU+3, 7, 2, "The Violet Hold", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach The Violet Hold willst?"),
(@GOSSIP_MENU+3, 8, 2, "Halls of Lightning", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Halls of Lightning willst?"),
(@GOSSIP_MENU+3, 9, 2, "Halls of Stone", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Halls of Stone willst?"),
(@GOSSIP_MENU+3, 10, 2, "Utgarde Keep", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Utgarde Keep willst?"),
(@GOSSIP_MENU+3, 11, 2, "Utgarde Pinnacle", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Utgarde Pinnacle willst?"),
(@GOSSIP_MENU+3, 12, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+4, 0, 2, "Der Schwarze Tempel", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zum Schwarze Tempel willst?"),
(@GOSSIP_MENU+4, 1, 2, "Pechschwingenhort", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zum Pechschwingenhort willst?"),
(@GOSSIP_MENU+4, 2, 2, "Hyjal Summit", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Hyjal Summit willst?"),
(@GOSSIP_MENU+4, 3, 2, "Serpentshrine Cavern", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Serpentshrine Cavern willst?"),
(@GOSSIP_MENU+4, 4, 2, "Trial of the Crusader", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Trial of the Crusader willst?"),
(@GOSSIP_MENU+4, 5, 2, "Gruuls Unterschlupf", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zu Gruuls Unterschlupf willst?"),
(@GOSSIP_MENU+4, 6, 2, "Magtheridons Kammer", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in Magtheridons Kammer willst?"),
(@GOSSIP_MENU+4, 7, 2, "Eiskrone Citadel", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Eiskrone Citadel willst?"),
(@GOSSIP_MENU+4, 8, 2, "Karazhan", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Karazhan willst?"),
(@GOSSIP_MENU+4, 9, 2, "Geschmolzener Kern", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zum Geschmolzenen Kern willst?"),
(@GOSSIP_MENU+4, 10, 2, "Naxxramas", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Naxxramas willst?"),
(@GOSSIP_MENU+4, 11, 2, "Onyxia's Lair", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Onyxia's Lair willst?"),
(@GOSSIP_MENU+4, 12, 2, "Ruins of Ahn'Qiraj", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Ruins of Ahn'Qiraj willst?"),
...
(@GOSSIP_MENU+4, 22, 2, "Zul'Aman", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Zul'Aman willst?"),
(@GOSSIP_MENU+4, 23, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+5, 0, 2, "Wald von Elwynn", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Wald von Elwynn willst?"),
(@GOSSIP_MENU+5, 1, 2, "Immersangwald", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Immersangwald willst?"),
(@GOSSIP_MENU+5, 2, 2, "Dun Morogh", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Dun Morogh willst?"),
(@GOSSIP_MENU+5, 3, 2, "Tirisfal", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Tirisfal willst?"),
(@GOSSIP_MENU+5, 4, 2, "Geisterlande", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in die Geisterlande willst?"),
(@GOSSIP_MENU+5, 5, 2, "Loch Modan", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Loch Modan willst?"),
(@GOSSIP_MENU+5, 6, 2, "Silberwald", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Silberwald willst?"),
(@GOSSIP_MENU+5, 7, 2, "Westfall", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Westfall willst?"),
(@GOSSIP_MENU+5, 8, 2, "Rotkammgebirge", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Rotkammgebirge willst?"),
(@GOSSIP_MENU+5, 9, 2, "Dämmerwald", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Dämmerwald willst?"),
(@GOSSIP_MENU+5, 10, 2, "Vorgebirge von Hillsbrad", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zum Vorgebirge von Hillsbrad willst?"),
(@GOSSIP_MENU+5, 11, 2, "Sumpfland", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in das Sumpfland willst?"),
(@GOSSIP_MENU+5, 12, 2, "Alteracgebirge", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in das Alteracgebirge willst?"),
(@GOSSIP_MENU+5, 13, 2, "Arathihochland", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in das Arathihochland willst?"),
(@GOSSIP_MENU+5, 14, 2, "Schlingendorntal", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du ins Schlingendorntal willst?"),
(@GOSSIP_MENU+5, 15, 2, "Badlands", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Badlands willst?"),
(@GOSSIP_MENU+5, 16, 2, "Swamp of Sorrows", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Swamp of Sorrows willst?"),
(@GOSSIP_MENU+5, 17, 2, "The Hinterlands", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach The Hinterlands willst?"),
(@GOSSIP_MENU+5, 18, 2, "Searing Gorge", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Searing Gorge willst?"),
(@GOSSIP_MENU+5, 19, 2, "The Blasted Lands", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach The Blasted Lands willst?"),
(@GOSSIP_MENU+5, 20, 2, "Burning Steppes", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Burning Steppes willst?"),
(@GOSSIP_MENU+5, 21, 2, "Western Plaguelands", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Western Plaguelands willst?"),
(@GOSSIP_MENU+5, 22, 2, "Eastern Plaguelands", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Eastern Plaguelands willst?"),
(@GOSSIP_MENU+5, 23, 2, "Insel von Quel'Danas", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zur Insel von Quel'Danas willst?"),
(@GOSSIP_MENU+5, 24, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+6, 0, 2, "Azurmythosinsel", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du auf die Azurmythosinsel willst?"),
(@GOSSIP_MENU+6, 1, 2, "Teldrassil", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Teldrassil willst?"),
(@GOSSIP_MENU+6, 2, 2, "Durotar", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Durotar willst?"),
(@GOSSIP_MENU+6, 3, 2, "Mulgore", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Mulgore willst?"),
(@GOSSIP_MENU+6, 4, 2, "Blutmythosinsel", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Blutmythosinsel willst?"),
(@GOSSIP_MENU+6, 5, 2, "Dunkelküste", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Dunkelküste willst?"),
(@GOSSIP_MENU+6, 6, 2, "Das Brachland", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Das Brachland willst?"),
(@GOSSIP_MENU+6, 7, 2, "Steinkrallengebirge", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass in das Steinkrallengebirge willst?"),
(@GOSSIP_MENU+6, 8, 2, "Nachtweisenwald", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in den Nachtweisenwald willst?"),
(@GOSSIP_MENU+6, 9, 2, "Tausend Nadeln", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Tausend Nadeln willst?"),
(@GOSSIP_MENU+6, 10, 2, "Desolace", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Desolace willst?"),
(@GOSSIP_MENU+6, 11, 2, "Dustwallow Marsh", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Dustwallow Marsh willst?"),
(@GOSSIP_MENU+6, 12, 2, "Feralas", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Feralas willst?"),
(@GOSSIP_MENU+6, 13, 2, "Tanaris Desert", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Tanaris Desert willst?"),
(@GOSSIP_MENU+6, 14, 2, "Azshara", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Azshara willst?"),
(@GOSSIP_MENU+6, 15, 2, "Felwood", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Felwood willst?"),
(@GOSSIP_MENU+6, 16, 2, "Un'Goro Crater", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Un'Goro Crater willst?"),
(@GOSSIP_MENU+6, 17, 2, "Silithus", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Silithus willst?"),
(@GOSSIP_MENU+6, 18, 2, "Winterspring", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Winterspring willst?"),
(@GOSSIP_MENU+6, 19, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+7, 0, 2, "Höllenfeuerhalbinsel", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du auf die Höllenfeuerhalbinsel willst?"),
(@GOSSIP_MENU+7, 1, 2, "Zangarmarsh", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Zangarmarsh willst?"),
(@GOSSIP_MENU+7, 2, 2, "Terokkar Forest", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Terokkar Forest willst?"),
(@GOSSIP_MENU+7, 3, 2, "Nagrand", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Nagrand willst?"),
(@GOSSIP_MENU+7, 4, 2, "Schergrat", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach zum Schergrat willst?"),
(@GOSSIP_MENU+7, 5, 2, "Netherstorm", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Netherstorm willst?"),
(@GOSSIP_MENU+7, 6, 2, "Schattenmondtal", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in das Schattenmondtal willst?"),
(@GOSSIP_MENU+7, 7, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+8, 0, 2, "Boreanische Tundra", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zur Boreanischen Tundra willst?"),
(@GOSSIP_MENU+8, 1, 2, "Heulende Fjord", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zum Heulende Fjord willst?"),
(@GOSSIP_MENU+8, 2, 2, "Drachenöde", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in die Drachenöde willst?"),
(@GOSSIP_MENU+8, 3, 2, "Grizzlyhügel", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in die Grizzlyhügel willst?"),
(@GOSSIP_MENU+8, 4, 2, "Zul'Drak", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Zul'Drak willst?"),
(@GOSSIP_MENU+8, 5, 2, "Sholazarbecken", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du zum Sholazarbecken willst?"),
(@GOSSIP_MENU+8, 6, 2, "Kristallsangwald", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Kristallsangwald willst?"),
(@GOSSIP_MENU+8, 7, 2, "Das Auge des Sturms", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du in das Auge des Sturms willst?"),
(@GOSSIP_MENU+8, 8, 2, "Eiskrone", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Eiskrone willst?"),
(@GOSSIP_MENU+8, 9, 2, "Tausendwinter", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Tausendwinter willst?"),
