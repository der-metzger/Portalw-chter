...
(@GOSSIP_MENU, 11, 2, "Booty bay", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Booty bay willst?"),
(@GOSSIP_MENU, 12, 2, "Gurubashi arena", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, dass du nach Arena willst?"),
...
(@GOSSIP_MENU+5, 14, 2, "Stranglethorn Vale", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Stranglethorn Vale willst?"),
...
(@GOSSIP_MENU+6, 0, 2, "Azuremyst Isle", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Azuremyst Isle willst?"),
...
(@GOSSIP_MENU+6, 7, 2, "Stonetalon Mountains", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Stonetalon Mountains willst?"),
(@GOSSIP_MENU+6, 8, 2, "Ashenvale Forest", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Ashenvale Forest willst?"),
...
(@GOSSIP_MENU+7, 0, 2, "Hellfire Peninsula", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Hellfire Peninsula willst?"),
...
(@GOSSIP_MENU+7, 4, 2, "Blade's Edge Mountains", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Blade's Edge Mountains willst?"),
(@GOSSIP_MENU+7, 5, 2, "Netherstorm", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Netherstorm willst?"),
(@GOSSIP_MENU+7, 6, 2, "Shadowmoon Valley", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Shadowmoon Valley willst?"),
(@GOSSIP_MENU+7, 7, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+8, 0, 2, "Borean Tundra", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Borean Tundra willst?"),
(@GOSSIP_MENU+8, 1, 2, "Howling Fjord", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Howling Fjord willst?"),
(@GOSSIP_MENU+8, 2, 2, "Dragonblight", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Dragonblight willst?"),
(@GOSSIP_MENU+8, 3, 2, "Grizzly Hills", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Grizzly Hills willst?"),
(@GOSSIP_MENU+8, 4, 2, "Zul'Drak", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Zul'Drak willst?"),
(@GOSSIP_MENU+8, 5, 2, "Sholazar Basin", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Sholazar Basin willst?"),
(@GOSSIP_MENU+8, 6, 2, "Crystalsong Forest", 1, 1, 0, 0, 0, 0, "Bist du sicher, dass du nach Crystalsong Forest willst?"),
